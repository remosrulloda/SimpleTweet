...
public class TimelineActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { // returns a boolean
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK){
            ...
            Tweet tweet = Parcels.unwrap(data.getParcelableExtra("tweet")); //result of what the user has published onto ComposeActivity
    ...
    private void populateHomeTimeline() {
        // call the API method using Twitter Client
